...
FString URealtimeDatabase::JsonStringFromNumber(const TMap<FString, float> Map)
{
...
FString URealtimeDatabase::JsonStringFromBool(const TMap<FString, bool> Map)
{
    const TSharedPtr<FJsonObject> JsonObject = MakeShareable(new FJsonObject());
    FString OutputString;
...
FString URealtimeDatabase::JsonStringFromString(const TMap<FString, FString> Map)
{
    const TSharedPtr<FJsonObject> JsonObject = MakeShareable(new FJsonObject());
    FString OutputString;
...
FString URealtimeDatabase::JsonStringFromJsonString(const TArray<FString> Children)
{
...
FString URealtimeDatabase::JsonFieldFromBoolArray(const FString Key, const TArray<bool> Array)
{
    TSharedPtr<FJsonObject> JsonObject = MakeShareable(new FJsonObject());
    FString OutputString;
...
FString URealtimeDatabase::JsonFieldFromNumberArray(const FString Key, const TArray<float> Array)
{
    TSharedPtr<FJsonObject> JsonObject = MakeShareable(new FJsonObject());
    FString OutputString;
...
FString URealtimeDatabase::JsonFieldFromStringArray(const FString Key, const TArray<FString> Array)
{
    TSharedPtr<FJsonObject> JsonObject = MakeShareable(new FJsonObject());
    FString OutputString;
...
FString URealtimeDatabase::MakeParentChildJson(const FString Parent, const FString ChildKey, const FString ChildValue)
{
    TSharedPtr<FJsonObject> ParentObject = MakeShareable(new FJsonObject());
